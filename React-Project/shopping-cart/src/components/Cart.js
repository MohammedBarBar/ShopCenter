...
import '../index.css';
import { removeItem,addQuantity,subtractQuantity,addtoAddedItems} from './actions/cartActions'
...
class Cart extends Component{
    ...
    render(){
        ...
        //  console.log(this.props.items === JSON.parse(localStorage.getItem('cc')));
                        ...
                        <li className="collection-item avatar" key={item.idProducts}>
                                    ...
                                    <div className="item-desc">
                                        ...
                                        <div className="add-remove">
                                            <Link to="/cart"><i className="material-icons" onClick={()=>{this.handleAddQuantity(item.idProducts)}}>arrow_drop_up</i></Link>
                                            <Link to="/cart"><i className="material-icons" onClick={()=>{this.handleSubtractQuantity(item.idProducts)}}>arrow_drop_down</i></Link>
                                        </div>
                                        <button className="waves-effect waves-light btn pink remove" onClick={()=>{this.handleRemove(item.idProducts)}}>Remove</button>
                                    </div>
...
const mapDispatchToProps = (dispatch)=>{
    return{
        ...
        addtoAddedItems: (data)=>{dispatch(addtoAddedItems(data))}
